    ...
    render: function() {
        return (
            React.createElement("div", {className: "calculator"}, 
                ...
                React.createElement(CalculatorButtons, {buttons: data})
            )
        );   
    }
});
...
var CalculatorButtons = React.createClass({displayName: "CalculatorButtons",
    ...
    render: function() {
        var buttons = this.props.buttons.map(function(button) {
            return  React.createElement("input", {type: "button", value: button.title, onClick: handleClick, key: button.title})
        });
        return (  
